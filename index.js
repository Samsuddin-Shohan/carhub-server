...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.clkdx.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;


// const connectionString=`mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.clkdx.mongodb.net/carhub`;
